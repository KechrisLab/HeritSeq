...
#' @param alphas Vector for the intercepts in the GLMM's, \eqn{\alpha_g}'s.
#' @param sigma2s Variance vector of the strain random effect, 
#' \eqn{\sigma^2_g}'s.
#' @param phis Dispersion vector in the NB models, \eqn{\phi_g}'s; common 
#' across strains per feature.
#' @return A \eqn{G \times N}{G x N} matrix with NB counts. \eqn{N} is the 
#' total number of 
...
#' consists of p-values for testing the hypothesis that the random effect 
#' \eqn{\sigma_g^2 = 0}.
#' @examples
...
#' intercept \eqn{\alpha_g}, random effect variance \eqn{\sigma_g^2}, and 
#' disperssion \eqn{\phi_g}{}. 
...
#' \eqn{\alpha_g}, random effect \eqn{\sigma_g^2}, tweedie parameter 
#' \eqn{p_g}, and dispersion \eqn{\phi}.
#' @return A \eqn{G \times 1}{G x 1} matrix consisting of VPC for
