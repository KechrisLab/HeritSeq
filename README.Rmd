...
```
Since R for OS X Maverick (and latter versions) was compiled using gfortran-4.8, Mac users might recieve a “-lgfortran” error when installing the cplm package. This problem and its solution are stated [here]( http://thecoatlessprofessor.com/programming/rcpp-rcpparmadillo-and-os-x-mavericks-lgfortran-and-lquadmath-error/).
